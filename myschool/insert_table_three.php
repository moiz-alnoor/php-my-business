<?
    ...
    $r=mysql_query("INSERT INTO student_three(no,name,level,class,address,tel,bday,dgree,lastedu,fname,fadd,ftel,amountmgrer,numbergst,note,amountrim)
...
'$_POST[lastedu]','$_POST[fname]','$_POST[fadd]','$_POST[ftel]','$_POST[amountmgrer]','$_POST[numbergst]','$_POST[note]','$a')");
    if($r)
    {
        echo "<script> alert('تم تسجيل الطالب ضمن طلاب المستوي الثالث');</script>";
