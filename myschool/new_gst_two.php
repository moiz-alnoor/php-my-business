<?
    ...
    $w=mysql_query("select * from student_two where number = '$n'");
    ...
    if($t['vgstone']<1){
            ...
            $m=mysql_query("update student_two set vgstone='$v_new',dgstone='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
        ...
        case 2;
            if($t['vgsttwo']<1){
            $m=mysql_query("update student_two set vgsttwo='$v_new',dgsttwo='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'   where number ='$number'");
    ...
    if($t['vgstthree']<1){
        ...
        $m=mysql_query("update student_two set vgstthree='$v_new',dgstthree='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
    ...
    if($t['vgstfour']<1){
        ...
        $m=mysql_query("update student_two set  vgstfour='$v_new',dgstfour='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
    ...
    if($t['vgstfive']<1){
        ...
        $m=mysql_query("update student_two set  vgstfive='$v_new',dgstfive='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
        ...
        case 6:
            if($t['vgstsex']<1){
                ...
                $m=mysql_query("update student_two set  vgstsex='$v_new',dgstfive='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
        ...
        case 7:
            if($t['vgstseven']<1){
                ...
                $m=mysql_query("update student_two set  vgstseven='$v_new',dgstfive='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
        ...
        case 8:
            if($t['vgsteyt']<1){
                ...
                $m=mysql_query("update student_two set  vgsteyt='$v_new',dgstfive='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
