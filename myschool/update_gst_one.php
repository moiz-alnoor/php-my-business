...
include("conn.php");
    ...
    $m=mysql_query("update student set vgstone ='$vgstone', vgsttwo ='$vgsttwo', vgstthree ='$vgstthree', vgstfour ='$vgstfour', vgstfive='$vgstfive',
...
<?
    ...
    $a=mysql_query("select * from student where number ='$num'");
   ...
   $amountrim=$b['amountrim'];
    ...
    $m=mysql_query("update student set amountrim ='$amountrim',totalamountdue ='$total'  where number ='$num'");
