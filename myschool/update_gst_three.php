<?php
    ...
    $m=mysql_query("update student_three set vgstone ='$vgstone', vgsttwo ='$vgsttwo', vgstthree ='$vgstthree', vgstfour ='$vgstfour', vgstfive='$vgstfive',
...
<?
    ...
    $a=mysql_query("select * from student_three where number ='$num'");
    ...
    $m=mysql_query("update student_three set amountrim ='$amountrim',totalamountdue ='$total'  where number ='$num'");
