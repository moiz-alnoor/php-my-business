<?
    ...
    $w=mysql_query("select * from student where number ='$n'");
...
case 1:
if($t['vgstone']<1){
    $m=mysql_query("update student set vgstone='$v_new',dgstone='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
...
case 2;
    if($t['vgsttwo']<1){
$m=mysql_query("update student set vgsttwo='$v_new',dgsttwo='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'   where number ='$number'");
...
case 3;
    if($t['vgstthree']<1){
$m=mysql_query("update student set vgstthree='$v_new',dgstthree='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
...
case 4:
    if($t['vgstfour']<1){
$m=mysql_query("update student set  vgstfour='$v_new',dgstfour='$d_new_gst',amountrim ='$amountrim',totalamountdue='$total'  where number ='$number'");
...
case 5:
    if($t['vgstfive']<1){
        ...
        $m=mysql_query("update student set  vgstfive ='$v_new',dgstfive='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
...
break;
        case 6:
            if($t['vgstsex']<1){
                ...
                $m=mysql_query("update student set  vgstsex ='$v_new',dgstsex='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
        ...
        case 7:
            if($t['vgstseven']<1){
                ...
                $m=mysql_query("update student set  vgstseven ='$v_new',dgstseven='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
        ...
        case 8:
            if($t['vgsteyt']<1){
                ...
                $m=mysql_query("update student set  vgsteyt ='$v_new',dgsteyt='$d_new_gst' ,amountrim ='$amountrim',totalamountdue='$total' where number ='$number'");
