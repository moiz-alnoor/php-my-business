...
<div class="header">
    <div class="pp" >ثانوية الأوائل # </div>
</div>
...
<aside  style="position: absolute;padding-top: 3.5em; left:29.3em; top:17em; background-color:black;color: white; border-radius:15px;font-size: large; text-align: center;height: 5.7em; width: 17.7em;">
    ...
    <?$name=$_POST['name']; echo "أنت علي وشك حزف سجل غياب الطالب ".$name ?>

</aside>

<form action="delete_ou.php" method="post">
...
<?php
    ...
    switch($r){
        ...
        case 1:
            ...
            $m=mysql_query("delete from ou where number ='$s'");
